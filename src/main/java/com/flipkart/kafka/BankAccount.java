...
public class BankAccount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6671377146391537097L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BankAccount\",\"namespace\":\"com.flipkart.kafka\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"amount\",\"type\":\"double\",\"default\":0},{\"name\":\"timestamp\",\"type\":\"long\"}]}");
   ...
   */
  public BankAccount(java.lang.Integer id, java.lang.String name, java.lang.Double amount, java.lang.Long timestamp) {
    this.id = id;
    this.name = name;
    this.amount = amount;
   ...
   */
  public static com.flipkart.kafka.BankAccount.Builder newBuilder() {
    return new com.flipkart.kafka.BankAccount.Builder();
  }
   ...
   * @return A new BankAccount RecordBuilder
   */
  public static com.flipkart.kafka.BankAccount.Builder newBuilder(com.flipkart.kafka.BankAccount.Builder other) {
    return new com.flipkart.kafka.BankAccount.Builder(other);
  }
   ...
   * @return A new BankAccount RecordBuilder
   */
  public static com.flipkart.kafka.BankAccount.Builder newBuilder(com.flipkart.kafka.BankAccount other) {
    return new com.flipkart.kafka.BankAccount.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BankAccount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.flipkart.kafka.BankAccount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.flipkart.kafka.BankAccount other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flipkart.kafka.BankAccount.Builder clearTimestamp() {
